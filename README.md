...
Applicazione realizzata per l'esame di Basi di Dati presso l'Università degli Studi di Salerno.

Il progetto consiste nel database di un hotel che gestisce online i clienti, le loro prenotazioni, i soggiorni, le camere, i servizi e le recensioni. Comprende la progettazione (schema E-R e schema logico), il database in MySQL con i dati di esempio, le query richieste dal corso e una piccola applicazione Java che accede al database tramite JDBC.
